...
class ATMLogin(tk.Frame):
    ...
    def __init__(self, master=None, **kwargs):
        ...
        # LOGIN SECTION
        self.log_name = tk.Label(self, text='Account Name', bg=w, font='Courier 10')
...
class ATMAction(tk.Frame):
    ...
    def __init__(self, name_var, master=None, **kwargs):
        ...
        self.drawe.grid(row=2, column=1, pady=30, padx=4, sticky='n')
        ...
        self.depe.grid(row=3, column=1, pady=30, padx=4, sticky='n')
